...
$classes			= $css_class.'thz-shc thz-text-block'.$animation_class.$cpx_class.$res_class;
$text 				= $atts['text'];

?>
<div id="<?php echo esc_attr( $id_out ) ?>" class="<?php echo thz_sanitize_class($classes); ?>"<?php echo thz_sanitize_data($animation_data.$cpx_data) ?>><?php echo thz_html_trans(esc_textarea(do_shortcode( $text ))); ?></div>