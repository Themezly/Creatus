...
+function ($) {
  ...
  Tooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="thz-tip" role="tooltip"><div class="thz-tip-arrow"></div><div class="thz-tip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  Tooltip.prototype.setContent = function () {
    ...
    $tip.find('.thz-tip-inner')[this.options.html ? 'html' : 'text'](title)
...
+function ($) {
  ...
  Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
    ...
    trigger: 'click',
    content: '',
    template: '<div class="thz-popover" role="tooltip"><div class="arrow"></div><h3 class="thz-popover-title"></h3><div class="thz-popover-content"></div></div>'
  })
