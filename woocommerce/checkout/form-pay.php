...
<form id="order_review" method="post">
	<div class="thz-woo-table-holder">
		<table class="thz-woo-table thz-table thz-table-bordered shop_table">
			<thead>
				<tr>
