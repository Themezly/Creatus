...
1. Go to your WordPress dashboard (Ex: http://your_wp_install/wp-admin )
2. Go to Appearance > Themes than click on Add New button.
3. Locate the Upload Theme button and click on it.
4. Click on Choose File button, select the Creatus-WP-Version#.zip archive and click on Install Now button.

== License ==

Creatus is licensed under the GNU General Public License v2 or later
